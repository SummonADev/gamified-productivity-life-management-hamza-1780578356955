...
const AchievementsPage: React.FC = () => {
  ...
  return (
    <div className="animate-fade-in max-w-3xl mx-auto space-y-6">
      ...
      <p className="text-bark">{unlocked.length}/{state.achievements.length} unlocked</p>
      ...
      {unlocked.length > 0 && (
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {unlocked.map((a) => (
              <div key={a.id} className="bg-cloud rounded-xl p-4 flex items-center gap-3 animate-sparkle">
